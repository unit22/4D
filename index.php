                        ...
                        <div id="wrap">
                            ...
                            foreach ($dates2 as $date){
                                ...
                                if (is_dir($path) && ($date != '.') && ($date != '..')){
                                    $mastera2 = scandir($path);
                                    $mastera = array_diff($mastera2, array('ЧД ЗАВЕРШЕНО'));# удалить папки с именем ЧД ЗАВЕРШЕНО


                                    if (countImagesInDate($mastera, $path) == 0){
                                        continue;# ======================================= в пн раскомментировать ===============================================
//                                        echo '<table style="width:100%; background-color:#98FB98; margin-top: 50px;"><tbody><tr><td align="left" style="padding-left: 10px;"><h1>'.'&nbsp;'.$date.'</h1></td><td align="right" style="padding-right: 10px;"></td></tr></tbody></table>';
                                    } else {
                                    ...
                                    foreach ($mastera as $master){
                                        ...
                                        if (is_dir($path2) && ($master != '.') && ($master != '..')){
                                            ...
                                            echo '<br><br><div class="container gallery">';
